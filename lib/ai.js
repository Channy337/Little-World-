...
function buildPrompt(item) {
  if (item.type === 'priority') {
    const materialNames={fiber:'plant strands',clay:'sticky earth',ore:'heavy reddish stone',bone:'hard animal remains',hide:'animal skin'};
