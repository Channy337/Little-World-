...
function buildPrompt(item) {
  if (item.type === 'priority') {
    return [
      ...
      'Right now: hunger ' + item.hunger + '/100 (higher = hungrier), hydration reserve about ' + item.hydration + '/100, energy ' + item.energy + '/100, social comfort ' + item.social + '/100. ' +
      ...
      'If they have a concrete idea worth testing, use only these broad operations: observe, combine, shape, stack, soak, dry, heat, compare. Materials may name wood, stone, food, or their own body. Wood, stone, and food require carried inventory; body means only non-invasive self-observation. Otherwise set experiment to null.',
