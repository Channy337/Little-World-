...
const SAFETY_NOTE = "Keep it cozy and low-stakes: no graphic violence, no adult content. " +
  "Treat this as one person's limited point of view. Never give them knowledge they have not sensed, learned, remembered, or been told. " +
  "Do not invent a discovery just because you know how the real world works. Respond with ONLY the JSON object, nothing else.";
...
function buildPrompt(item) {
  if (item.type === 'priority') {
    return [
      ...
      mindLine(item.mind),
      '',
      'Think as this individual, not as a game controller. Their personality, feelings, memories, relationships, skill, and limited knowledge should matter. '+
        'They may be uncertain or wrong. They can form a personal goal, but must not magically know a recipe, technology, resource use, or location they have never learned.',
