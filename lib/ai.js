...
const SAFETY_NOTE = "Keep it cozy and low-stakes: no graphic violence, no adult content. " +
  ...
  "Do not claim a hypothesis is true before Civoria tests it. Never reveal chemical names, formulas, atoms, molecules, or invisible properties unless this person has an observation from a capable instrument. Respond with ONLY the JSON object, nothing else.";
...
function buildPrompt(item) {
  if (item.type === 'priority') {
    ...
    return [
      ...
      'If they have a concrete idea worth testing, choose a broad physical operation and a simple visible form. Materials must be things they currently carry; body means only non-invasive self-observation. Otherwise set experiment to null.',
