...
function forage(agent,bush,day,state){
  ...
  if(state)collectSeed(state,agent,bush,day);
  return item;
}
...
module.exports={PLANTS,ANIMAL_SPECIES,ensureEcology,forage,consume,canConsume,recordFoodOutcome,foodSummary,syncFoodState,drinkRisk,addWaste,advance,sensoryFood,sensoryAnimal};
