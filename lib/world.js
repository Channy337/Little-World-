...
logger(JSON.stringify({event:heartbeat?'world_heartbeat':'world_tick',revision:next.revision,simulatedMs,skippedMs,worldSecondsAdvanced,population:state.agents.length,day:state.day,aiRequests:queue.length}));
