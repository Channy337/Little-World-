...
test('foundational consequences are visible while canonical state remains server-owned',()=>{
  ...
  assert.match(html,/V0\.12\.2/);assert.match(html,/No invisible map/);assert.match(html,/physical prototypes/i);
  ...
  assert.match(html,/Living Planet Observer/);assert.match(html,/Open Life Profile|jarvis-profile\.js/);
