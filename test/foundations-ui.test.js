...
test('foundational consequences are visible while canonical state remains server-owned',()=>{
  ...
  assert.match(panel,/Life stage/);assert.match(panel,/Appearance · inherited/);assert.match(panel,/Artifacts & prototypes/);assert.match(panel,/Oxygen/);assert.match(panel,/Infection load/);
